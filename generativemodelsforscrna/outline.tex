...
We see that for some genes the $p$ values (which should be distributed uniformly) are almost always near 1.  We can dig deeper into this by looking at individual genes, and comparing the expected value for that gene under the model with the actual value.  There are clearly some systematic differences:
